            ...
            <tr>
                ...
                <td>
                    <div class="action-links">
                        <a href="#" onclick="showPatientDetails({{ $patient->id }}, '{{ $patient->name }}', '{{ $patient->email }}', '{{ $patient->phone ?? '' }}', '{{ $patient->disease_illness ?? '' }}', '{{ $patient->medical_history ?? '' }}')" class="btn-view">👁️ View</a>
